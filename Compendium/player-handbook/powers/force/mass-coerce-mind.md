...
* Pages: 256-256
* Original section: Mass Coerce Mind

## Quick Use

A 6 force power for Wisdom save pressure. Use the source page for exact effect text.
...
`force`, `level-6`, `mass-coerce-mind`, `power`, `wisdom-save`
