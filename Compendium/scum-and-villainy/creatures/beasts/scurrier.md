...
page_start: 176
page_end: 176
tags: ["beast", "beasts", "combatant", "cr-1-4", "creature", "scurrier", "statblock"]
status: "draft"
verbatim_risk: "low"
creature_name: "Scurrier"
creature_type: "beast"
size: "Small"
alignment: "unaligned"
...
hit_points: "7 (2d6)"
speed: "30 ft."
abilities: {"str": "7 (-2)", "dex": "15 (+2)", "con": "11 (+0)", "int": "2 (-4)", "wis": "10 (-0)", "cha": "4 (-3)"}
saving_throws: []
skills: []
...
* Pages: 176-176
* Original section: Scurrier

## Quick Identity

* Type: Small beast, unaligned
* Role: combatant
* Main danger: Bite, Ram
* Star Wars context: use as a unknown threat or encounter piece when that faction/context fits.

## Stat Summary

* Size / Type / Alignment: Small beast, unaligned
* CR / XP: 1/4 / 50
* AC: 11 (natural armor)
* HP: 7 (2d6)
* Speed: 30 ft.
* Key abilities: STR 7 (-2), DEX 15 (+2), CON 11 (+0), INT 2 (-4), WIS 10 (-0), CHA 4 (-3)
* Saves: none detected
...
`beast`, `beasts`, `combatant`, `cr-1-4`, `creature`, `scurrier`, `statblock`
