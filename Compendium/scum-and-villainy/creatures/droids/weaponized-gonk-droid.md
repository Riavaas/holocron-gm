...
section: "Weaponized Gonk Droid"
page_start: 116
page_end: 116
tags: ["cr-1-8", "creature", "droid", "droids", "ranged", "statblock", "weaponized-gonk-droid"]
status: "draft"
verbatim_risk: "low"
creature_name: "Weaponized Gonk Droid"
creature_type: "droid"
size: "Small"
alignment: "unaligned"
challenge_rating: "1/8"
xp: "25"
armor_class: "14(reinforced steel plating)"
hit_points: "5(1d6 + 2)"
speed: "15 ft."
abilities: {"str": "10 (+0)", "dex": "12 (+1)", "con": "14 (+2)", "int": "9 (-1)", "wis": "7 (-2)", "cha": "8 (-1)"}
saving_throws: []
skills: []
damage_vulnerabilities: ["ion", "lightning"]
...
traits: ["Explosive Destruction"]
actions: ["Kick", "Blaster Rifle"]
reactions: []
legendary_actions: []
lair_actions: []
regional_effects: []
...
* Pages: 116-116
* Original section: Weaponized Gonk Droid

## Quick Identity

* Type: Small droid, unaligned
* Role: ranged
* Main danger: Kick, Blaster Rifle
* Star Wars context: use as a unknown threat or encounter piece when that faction/context fits.

## Stat Summary

* Size / Type / Alignment: Small droid, unaligned
* CR / XP: 1/8 / 25
* AC: 14(reinforced steel plating)
* HP: 5(1d6 + 2)
* Speed: 15 ft.
* Key abilities: STR 10 (+0), DEX 12 (+1), CON 14 (+2), INT 9 (-1), WIS 7 (-2), CHA 8 (-1)
* Saves: none detected
...
* Combat role: ranged.
* Danger level: CR 1/8; verify exact mechanics on the cited source page.
...
`cr-1-8`, `creature`, `droid`, `droids`, `ranged`, `statblock`, `weaponized-gonk-droid`
