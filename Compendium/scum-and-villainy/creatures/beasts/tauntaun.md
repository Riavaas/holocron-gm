...
page_start: 180
page_end: 180
tags: ["beast", "beasts", "combatant", "cr-1-8", "creature", "statblock", "tauntaun"]
status: "draft"
verbatim_risk: "low"
...
speed: "50 ft."
abilities: {"str": "16 (+3)", "dex": "8 (-1)", "con": "14 (+2)", "int": "2 (-4)", "wis": "8 (-1)", "cha": "5 (-3)"}
saving_throws: []
skills: []
...
* HP: 15 (2d10+4)
* Speed: 50 ft.
* Key abilities: STR 16 (+3), DEX 8 (-1), CON 14 (+2), INT 2 (-4), WIS 8 (-1), CHA 5 (-3)
* Saves: none detected
...
`beast`, `beasts`, `combatant`, `cr-1-8`, `creature`, `statblock`, `tauntaun`
