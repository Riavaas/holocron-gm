...
* Pages: 296-296
* Original section: Shatter

## Quick Use

A 2 tech power for damage, Constitution save pressure. Use the source page for exact effect text.
...
* Damage to roll: 1d8, 3d8, sonic
* Save DC: Constitution
* Attack roll: false
* Target/area: 60 feet  / 10-foot-radius
* Duration: Instantaneous
...
`constitution-save`, `level-2`, `power`, `shatter`, `sonic`, `tech`
