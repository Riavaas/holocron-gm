...
* Pages: 268-268
* Original section: Wound

## Quick Use

A 1 force power for damage, attack roll resolution, Constitution save pressure. Use the source page for exact effect text.
...
* Damage to roll: 1d8, 2d8, necrotic
...
`constitution-save`, `force`, `level-1`, `necrotic`, `power`, `wound`
