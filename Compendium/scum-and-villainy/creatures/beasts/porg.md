...
page_start: 115
page_end: 115
tags: ["beast", "beasts", "combatant", "cr-0", "creature", "porg", "statblock"]
status: "draft"
verbatim_risk: "low"
creature_name: "Porg"
creature_type: "beast"
...
abilities: {"str": "2 (-4)", "dex": "14 (+2)", "con": "8 (-1)", "int": "2 (-4)", "wis": "12 (+1)", "cha": "6 (-2)"}
saving_throws: []
skills: ["Perception +3"]
...
* Size / Type / Alignment: Tiny beast, unaligned
* CR / XP: 0 / 10
* AC: 12
* HP: 1 (1d4-1)
* Speed: 10 ft., fly 50 ft.
* Key abilities: STR 2 (-4), DEX 14 (+2), CON 8 (-1), INT 2 (-4), WIS 12 (+1), CHA 6 (-2)
* Saves: none detected
* Skills: Perception +3
* Senses: passive Perception 13
...
`beast`, `beasts`, `combatant`, `cr-0`, `creature`, `porg`, `statblock`
