...
* Pages: 277-277
* Original section: Disintegrate

## Quick Use

A 6 tech power for damage, Dexterity save pressure. Use the source page for exact effect text.
...
`acid`, `dexterity-save`, `disintegrate`, `level-6`, `power`, `tech`
