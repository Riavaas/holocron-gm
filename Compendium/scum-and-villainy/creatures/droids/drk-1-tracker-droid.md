...
section: "DRK-1 Tracker Droid"
page_start: 143
page_end: 143
tags: ["cr-0", "creature", "drk-1-tracker-droid", "droid", "droids", "ranged", "statblock"]
status: "draft"
verbatim_risk: "low"
creature_name: "DRK-1 Tracker Droid"
creature_type: "droid"
size: "Tiny"
alignment: "unaligned"
challenge_rating: "0"
...
languages: []
traits: ["Circuitry", "Interfaced Tracking Protocol"]
actions: ["Shockprod"]
reactions: []
legendary_actions: []
lair_actions: []
...
* Pages: 143-143
* Original section: DRK-1 Tracker Droid

## Quick Identity

* Type: Tiny droid, unaligned
* Role: ranged
...
* Size / Type / Alignment: Tiny droid, unaligned
* CR / XP: 0 / 10
* AC: 11
* HP: 1 (1d4-1)
* Speed: 5 ft., fly 60 ft.
* Key abilities: STR 3 (-4), DEX 13 (+1), CON 8 (-1), INT 2 (-4), WIS 12 (+1), CHA 7 (-2)
* Saves: none detected
* Skills: Perception +3, Stealth +3, Survival +3
* Senses: Darkvision 120 ft, passive Perception 13
...
Circuitry, Interfaced Tracking Protocol
...
* Combat role: ranged.
* Danger level: CR 0; verify exact mechanics on the cited source page.
...
`cr-0`, `creature`, `drk-1-tracker-droid`, `droid`, `droids`, `ranged`, `statblock`
