...
* Pages: 246-246
* Original section: Force Link

## Quick Use

A 8 force power for utility or narrative effect. Use the source page for exact effect text.
...
`force`, `force-link`, `level-8`, `power`
