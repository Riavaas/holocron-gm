...
* Pages: 247-247
* Original section: Force Propel

## Quick Use

A 1 force power for damage, Dexterity save pressure. Use the source page for exact effect text.
...
* Damage to roll: 1d8, 3d8, kinetic
* Save DC: Dexterity
* Attack roll: false
* Target/area: 60 feet 
* Duration: Instantaneous
...
`dexterity-save`, `force`, `force-propel`, `kinetic`, `level-1`, `power`
