...
section: "Exogorth, Adolescent"
page_start: 49
page_end: 49
tags: ["beast", "beasts", "combatant", "cr-11", "creature", "exogorth-adolescent", "statblock"]
status: "draft"
verbatim_risk: "low"
creature_name: "Exogorth, Adolescent"
creature_type: "beast"
size: "Huge"
alignment: "unaligned"
challenge_rating: "11"
...
abilities: {"str": "23 (+6)", "dex": "16 (+3)", "con": "18 (+4)", "int": "1 (-5)", "wis": "10 (+0)", "cha": "8 (-1)"}
saving_throws: ["Con +8", "Wis +4"]
skills: []
damage_vulnerabilities: []
damage_resistances: ["acid", "poison (interior only); energy", "ion", "kinetic from unenhanced weapons (exterior only)"]
damage_immunities: []
condition_immunities: []
senses: ["Blindsight 30 Ft", "Tremorsense 60 Ft", "passive Perception 10"]
languages: []
traits: ["Tunneler", "Legendary Resistance (1/day)", "Huge Strength", "Siege Monster", "Space-borne"]
...
* Pages: 49-49
* Original section: Exogorth, Adolescent

## Quick Identity

* Type: Huge beast, unaligned
* Role: combatant
* Main danger: Multiattack, Bite, Tail
* Star Wars context: use as a unknown threat or encounter piece when that faction/context fits.

## Stat Summary

* Size / Type / Alignment: Huge beast, unaligned
* CR / XP: 11 / 7,200
* AC: 17 (Natural Armor)
* HP: 168 (16d12 + 64)
* Speed: 50 ft., burrow 30 ft.
* Key abilities: STR 23 (+6), DEX 16 (+3), CON 18 (+4), INT 1 (-5), WIS 10 (+0), CHA 8 (-1)
* Saves: Con +8, Wis +4
...
* Resistances: acid, poison (interior only); energy, ion, kinetic from unenhanced weapons (exterior only)
* Immunities: none detected
* Condition Immunities: none detected

## Traits

Tunneler, Legendary Resistance (1/day), Huge Strength, Siege Monster, Space-borne
...
* Combat role: combatant.
* Danger level: CR 11; verify exact mechanics on the cited source page.
...
* Put the creature in a scene that highlights its role: combatant.
* Tie its arrival to faction pressure: unknown.
* Use the environment tags as encounter dressing: flexible.
...
`beast`, `beasts`, `combatant`, `cr-11`, `creature`, `exogorth-adolescent`, `statblock`
