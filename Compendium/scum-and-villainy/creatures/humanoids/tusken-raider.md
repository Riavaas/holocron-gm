...
section: "Tusken Raider"
page_start: 154
page_end: 154
tags: ["combatant", "cr-1-2", "creature", "humanoid", "humanoids", "statblock", "tusken-raider"]
status: "draft"
verbatim_risk: "low"
...
xp: "100"
armor_class: "12 (combat suit)"
hit_points: "15 (2d8+6)"
speed: "30 ft."
abilities: {"str": "15 (+2)", "dex": "12 (+1)", "con": "16 (+3)", "int": "10 (+0)", "wis": "11 (+0)", "cha": "9 (-1)"}
saving_throws: []
skills: ["Survival +2"]
...
languages: ["Tusken"]
traits: ["Agressive"]
actions: ["Gaffi Stick", "Cycler Rifle"]
reactions: []
legendary_actions: []
lair_actions: []
regional_effects: []
...
* Pages: 154-154
* Original section: Tusken Raider

## Quick Identity

* Type: Medium humanoid, chaotic dark
* Role: combatant
* Main danger: Gaffi Stick, Cycler Rifle
* Star Wars context: use as a unknown threat or encounter piece when that faction/context fits.

## Stat Summary

* Size / Type / Alignment: Medium humanoid, chaotic dark
* CR / XP: 1/2 / 100
* AC: 12 (combat suit)
* HP: 15 (2d8+6)
* Speed: 30 ft.
* Key abilities: STR 15 (+2), DEX 12 (+1), CON 16 (+3), INT 10 (+0), WIS 11 (+0), CHA 9 (-1)
* Saves: none detected
* Skills: Survival +2
* Senses: passive Perception 10
* Languages: Tusken
...
`combatant`, `cr-1-2`, `creature`, `humanoid`, `humanoids`, `statblock`, `tusken-raider`
