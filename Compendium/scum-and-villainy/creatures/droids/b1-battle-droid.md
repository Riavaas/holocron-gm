...
section: "B1 Battle Droid"
page_start: 21
page_end: 21
tags: ["b1-battle-droid", "cr-1-8", "creature", "droid", "droids", "ranged", "statblock"]
status: "draft"
verbatim_risk: "low"
...
* Pages: 21-21
* Original section: B1 Battle Droid

## Quick Identity

* Type: Medium droid, unaligned
* Role: ranged
* Main danger: Blaster Rifle, Stock Strike
...
* HP: 7 (2d8-2)
* Speed: 30 ft.
* Key abilities: STR 9 (-1), DEX 14 (+2), CON 9 (-1), INT 13 (+1), WIS 10 (+0), CHA 7 (-2)
* Saves: none detected
...
`b1-battle-droid`, `cr-1-8`, `creature`, `droid`, `droids`, `ranged`, `statblock`
