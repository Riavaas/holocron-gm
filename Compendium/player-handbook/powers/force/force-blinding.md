...
* Pages: 244-244
* Original section: Force Blinding

## Quick Use

A 1 force power for condition control. Use the source page for exact effect text.
...
`blinded`, `force`, `force-blinding`, `level-1`, `power`
