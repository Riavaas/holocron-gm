...
* Pages: 243-243
* Original section: Enfeeble

## Quick Use

An at-will force power for damage, Wisdom save pressure. Use the source page for exact effect text.
...
* Damage to roll: 1d12, 1d8, necrotic
* Save DC: Wisdom
* Attack roll: false
* Target/area: 60 feet 
* Duration: Instantaneous
...
`enfeeble`, `force`, `level-at-will`, `necrotic`, `power`, `wisdom-save`
