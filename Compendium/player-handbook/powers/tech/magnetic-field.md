...
page_start: 287
page_end: 287
tags: ["concentration", "ion", "level-2", "magnetic-field", "power", "tech"]
status: "draft"
verbatim_risk: "low"
power_type: "tech"
level: "2"
...
* Pages: 287-287
* Original section: Magnetic Field

## Quick Use

A 2 tech power for damage, attack roll resolution, ongoing concentration. Use the source page for exact effect text.
...
* Save DC: 
* Attack roll: true
* Target/area: Self  / 10-foot radius
* Duration: Concentration, up to 1 hour
...
`concentration`, `ion`, `level-2`, `magnetic-field`, `power`, `tech`
