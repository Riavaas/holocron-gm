...
section: "Junk Behemoth"
page_start: 88
page_end: 88
tags: ["cr-1", "creature", "droid", "droids", "junk-behemoth", "ranged", "statblock"]
status: "draft"
verbatim_risk: "low"
creature_name: "Junk Behemoth"
creature_type: "droid"
size: "Huge"
alignment: "unaligned"
challenge_rating: "1"
xp: "200"
armor_class: "12 (armor scraps)"
hit_points: "57 (6d12+18)"
speed: "30 ft."
abilities: {"str": "16 (+3)", "dex": "12 (+1)", "con": "17 (+3)", "int": "6 (-2)", "wis": "8 (-1)", "cha": "5 (-3)"}
saving_throws: ["Dex +4"]
...
traits: ["Circuitry"]
actions: ["Multiattack", "Blaster Cannon", "Slam"]
reactions: ["Parry"]
legendary_actions: []
lair_actions: []
regional_effects: []
...
* Pages: 88-88
* Original section: Junk Behemoth

## Quick Identity

* Type: Huge droid, unaligned
* Role: ranged
* Main danger: Multiattack, Blaster Cannon, Slam
* Star Wars context: use as a unknown threat or encounter piece when that faction/context fits.

## Stat Summary

* Size / Type / Alignment: Huge droid, unaligned
* CR / XP: 1 / 200
* AC: 12 (armor scraps)
* HP: 57 (6d12+18)
* Speed: 30 ft.
* Key abilities: STR 16 (+3), DEX 12 (+1), CON 17 (+3), INT 6 (-2), WIS 8 (-1), CHA 5 (-3)
* Saves: Dex +4
* Skills: Perception +2, Stealth +4
* Senses: darkvision 60 ft, passive Perception 9
* Languages: Binary, Galactic Basic
...
Multiattack, Blaster Cannon, Slam
...
`cr-1`, `creature`, `droid`, `droids`, `junk-behemoth`, `ranged`, `statblock`
