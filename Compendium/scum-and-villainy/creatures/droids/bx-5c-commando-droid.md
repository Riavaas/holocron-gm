...
section: "BX-5c Commando Droid"
page_start: 24
page_end: 24
tags: ["bx-5c-commando-droid", "cr-5", "creature", "droid", "droids", "ranged", "skirmisher", "statblock"]
status: "draft"
verbatim_risk: "low"
creature_name: "BX-5c Commando Droid"
creature_type: "droid"
size: "Medium"
alignment: "unaligned"
challenge_rating: "5"
xp: "1,800"
armor_class: "16 (armor plating)"
hit_points: "96 (15d8+30)"
speed: "30 ft."
abilities: {"str": "13 (+1)", "dex": "19 (+4)", "con": "14 (+2)", "int": "15 (+2)", "wis": "13 (+1)", "cha": "7 (-1)"}
saving_throws: ["Dex +7"]
...
lair_actions: []
regional_effects: []
environment: ["urban", "military", "starship"]
faction: ["Separatist"]
role: ["skirmisher", "ranged"]
---
...
* Pages: 24-24
* Original section: BX-5c Commando Droid

## Quick Identity

* Type: Medium droid, unaligned
* Role: skirmisher, ranged
* Main danger: Multiattack, Blaster Carbine, Techblade, Stealth Field Generator
* Star Wars context: use as a Separatist threat or encounter piece when that faction/context fits.

## Stat Summary

* Size / Type / Alignment: Medium droid, unaligned
* CR / XP: 5 / 1,800
* AC: 16 (armor plating)
* HP: 96 (15d8+30)
* Speed: 30 ft.
* Key abilities: STR 13 (+1), DEX 19 (+4), CON 14 (+2), INT 15 (+2), WIS 13 (+1), CHA 7 (-1)
* Saves: Dex +7
* Skills: Perception +4, Stealth +7
* Senses: darkvision 60 ft, passive Perception 12
* Languages: Binary, Galactic Basic
...
Multiattack, Blaster Carbine, Techblade, Stealth Field Generator
...
* Legendary actions: None detected.
* Lair actions: none detected
* Regional effects: none detected

## GM Use

* Use this creature when its CR, faction, and environment fit the scene.
* Combat role: skirmisher, ranged.
* Danger level: CR 5; verify exact mechanics on the cited source page.
...
* Put the creature in a scene that highlights its role: skirmisher, ranged.
* Tie its arrival to faction pressure: Separatist.
* Use the environment tags as encounter dressing: urban, military, starship.
...
`bx-5c-commando-droid`, `cr-5`, `creature`, `droid`, `droids`, `ranged`, `skirmisher`, `statblock`
