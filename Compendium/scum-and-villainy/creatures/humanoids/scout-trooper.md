...
section: "Scout Trooper"
page_start: 60
page_end: 60
tags: ["combatant", "cr-1-2", "creature", "humanoid", "humanoids", "scout-trooper", "statblock"]
status: "draft"
verbatim_risk: "low"
creature_name: "Scout Trooper"
creature_type: "humanoid"
size: "Medium"
alignment: "any alignment"
challenge_rating: "1/2"
xp: "100"
armor_class: "15 (light battle armor)"
hit_points: "13 (2d8 + 4)"
speed: "30 ft. walk"
abilities: {"str": "11 (+0)", "dex": "15 (+2)", "con": "12 (+1)", "int": "14 (+2)", "wis": "13 (+1)", "cha": "9 (-1)"}
saving_throws: []
skills: ["Nature +4", "Perception +5", "Stealth +6", "Survival +5", "Piloting +4"]
...
actions: ["Multiattack", "Hold-out Blaster", "Vibrodagger"]
reactions: []
legendary_actions: []
lair_actions: []
regional_effects: []
...
* Pages: 60-60
* Original section: Scout Trooper

## Quick Identity

* Type: Medium humanoid, any alignment
* Role: combatant
* Main danger: Multiattack, Hold-out Blaster, Vibrodagger
* Star Wars context: use as a unknown threat or encounter piece when that faction/context fits.

## Stat Summary

* Size / Type / Alignment: Medium humanoid, any alignment
* CR / XP: 1/2 / 100
* AC: 15 (light battle armor)
* HP: 13 (2d8 + 4)
* Speed: 30 ft. walk
* Key abilities: STR 11 (+0), DEX 15 (+2), CON 12 (+1), INT 14 (+2), WIS 13 (+1), CHA 9 (-1)
* Saves: none detected
* Skills: Nature +4, Perception +5, Stealth +6, Survival +5, Piloting +4
* Senses: darkvision 60 ft, passive Perception 15
* Languages: Galactic Basic, one other
...
Multiattack, Hold-out Blaster, Vibrodagger
...
`combatant`, `cr-1-2`, `creature`, `humanoid`, `humanoids`, `scout-trooper`, `statblock`
