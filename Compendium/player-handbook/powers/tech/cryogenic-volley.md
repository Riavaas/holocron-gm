...
* Pages: 275-275
* Original section: Cryogenic Volley

## Quick Use

A 2 tech power for damage, Dexterity save pressure. Use the source page for exact effect text.
...
* Damage to roll: 1d6, 3d6, cold
* Save DC: Dexterity
* Attack roll: false
* Target/area: 90 feet  / 5-foot-radius
* Duration: Instantaneous
...
`cold`, `cryogenic-volley`, `dexterity-save`, `level-2`, `power`, `tech`
